...
export const register = async (req, res) => {
    ...
    try{
        ...
        const mailOptions = {
            ...
            text: `Hello ${name},\n\nWelcome to our platform! We're excited to have you on board. Your account has been successfully created with the email: ${email}\n\nBest regards,\nNadil Dulran Gamage`
        }
    ...
    try{
       ...
       await user.save();
         ...
         const mailOptions = {
            ...
            html: EMAIL_VERIFY_TEMPLATE.replace("{username}", user.name).replace("{{email}}", user.email).replace("{{otp}}", otp)
        };
        await transporter.sendMail(mailOptions);
    ...
    try{
       ...
       await user.save();
         ...
         const mailOptions = {
            ...
            html: PASSWORD_RESET_TEMPLATE.replace("{username}", user.name).replace("{{email}}", user.email).replace("{{otp}}", otp)
        };

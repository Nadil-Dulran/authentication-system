...
const Header = () => {
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        <h2 className='text-3xl sm:text-4xl font-semibold mb-4'>Welcome to the Authentication System</h2>
        <p className='mb-8 max-w-md'>Let's get started by logging in or creating an account.</p>
